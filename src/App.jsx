                ...
                <div className="choice-section">
                  ...
                  <div className="choices">
                    {chapter.choices.map((c, i) => (
                      <button key={i} className={`choice-btn ${selectedChoice === c ? "selected" : ""}`}
                        onClick={() => setSelectedChoice(c)}>{c}</button>
                    ))}
                  </div>
                  {selectedChoice && (
                    <button className="continue-btn" onClick={handleNextChapter}>Continue the Story →</button>
                  )}
                </div>
              )}
            </div>
